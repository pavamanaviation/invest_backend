...
from .models import (Admin, CompanyDroneModelInfo, CustomerRegister, DroneOperation,
...
def customer_login(request):
    ...
    try:
        ...
        if not customer:
            return JsonResponse({"error": "Customer account not found or not verified."}, status=404)
